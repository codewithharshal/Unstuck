...
const getPostAndComments = async (req, res) => {
  ...
  await post.populate("comments.commentedBy", "username");
  await post.populate("comments.replies.repliedBy", "username");
...
const createNewPost = async (req, res) => {
  ...
  await savedPost.populate("subreddit", "subredditName");
...
const updatePost = async (req, res) => {
  ...
  await savedPost.populate("author", "username");
  await savedPost.populate("subreddit", "subredditName");
  await savedPost.populate("comments.commentedBy", "username");
  await savedPost.populate("comments.replies.repliedBy", "username");
