...
export const useNavStyles = makeStyles(
  (theme) => ({
    ...
    logo: {
      // Use a heavier font for branding. If you want a specific webfont,
      // add it to index.html or import it in index.css (e.g., Poppins, Inter).
      fontFamily: "'Poppins', 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial",
      textTransform: 'none',
      fontSize: '1.6em',
      fontWeight: 800,
      padding: '0.1em',
...
export const usePostListStyles = makeStyles(
  (theme) => ({
    ...
    tabsColumn: {
      ...
      position: 'sticky',
      top: 64, /* height of AppBar/navbar */
      zIndex: 3,
      display: 'flex',
      justifyContent: 'center',
...
export const useSortTabStyles = makeStyles(
  (theme) => ({
    mainPaper: {
      ...
      marginBottom: '0.6em',
      minHeight: 48,
      // target MuiTab inside this paper to ensure consistent sizing
      '& .MuiTab-root': {
        minHeight: 40,
        padding: '6px 12px',
      },
    ...
    verticalTabs: {
      // refined style for vertical tab column: transparent, subtle divider and compact layout
      backgroundColor: 'transparent',
      borderRight: `2px solid ${theme.palette.type === 'light' ? 'rgba(0,0,0,0.06)' : 'rgba(255, 255, 255, 0.24)'}`,
      ...
      '& .MuiTab-root': {
        // center tab content and reduce padding to shrink width
        minWidth: 'auto',
        width: '100%',
        padding: '4px 6px',
        justifyContent: 'center',
        textTransform: 'none',
        '&.Mui-selected': {
          backgroundColor: 'rgba(255,69,32,0.06)',
          color: theme.palette.primary.main,
          borderLeft: `3px solid ${theme.palette.primary.main}`,
        },
        '&:hover': {
          backgroundColor: theme.palette.type === 'light' ? 'rgba(0,0,0,0.03)' : 'rgba(255,255,255,0.02)',
        },
      },
      '& .MuiTab-wrapper': {
        flexDirection: 'row',
...
export const useSubPanelStyles = makeStyles(
  (theme) => ({
    mainPaper: {
      // Make the right-side Top Communities panel a fixed, responsive width
      minWidth: 300,
      maxWidth: 300,
      maxHeight: '90%',
      width: '100%',
    ...
    sideWrapper: {
      // wrapper so TopSubsPanel renders as a single column element in the page layout
      minWidth: 300,
      maxWidth: 300,
      width: '100%',
      display: 'flex',
